	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane" id="mapoptions">
		    ...
		    <div class="form-group">
      		...
      		<div id="gdmap_canvas" style="height:600px;width:100%;"></div>
		</div>
...
//    });
    function loadMapLocationChoosing () {
        ...
        var map = new AMap.Map('gdmap_canvas', {
            resizeEnable: true,
            center:[<?php echo $geo_location_data['lng']?>,<?php echo $geo_location_data['lat'] ?>],
            zoom:14
        });
        var latLng = new AMap.LngLat(<?php echo $geo_location_data['lng']?>,<?php echo $geo_location_data['lat'] ?>);
        ...
        map.on('click', function(e) {
            ...
            $.postJSON('<?php echo erLhcoreClassDesign::baseurl('chat/geoconfiguration')?>/',{gmaps_api_key:$('#id_GMapsAPIKey').val(),zoom:map.getZoom(),store_map:1,csfr_token:confLH.csrf_token,lat:pos.getLat().toFixed(4),lng:pos.getLng().toFixed(4)}, function(data){
...
function gmaploadMapLocationChoosing(){
...
<script async defer src="<?php echo erLhcoreClassDesign::design('js/mapgoogle.js')?>"></script>