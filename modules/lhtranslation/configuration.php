...
if ( isset($_POST['StoreLanguageSettings']) || isset($_POST['StoreLanguageSettingsTest']) ) {
    ...
    $definition = array(
        ...
        'baidu_client_id' => new ezcInputFormDefinitionElement(
            ezcInputFormDefinitionElement::OPTIONAL, 'unsafe_raw'
        ),
        'baidu_client_secret' => new ezcInputFormDefinitionElement(
            ezcInputFormDefinitionElement::OPTIONAL, 'unsafe_raw'
        ),
    );
    ...
    if ( $form->hasValidData( 'baidu_client_id' )) {
        $data['baidu_client_id'] = $form->baidu_client_id;
    } else {
        $data['baidu_client_id'] = '';
    }

    if ( $form->hasValidData( 'baidu_client_secret' ) && $form->baidu_client_secret != '') {
        $data['baidu_client_secret'] = $form->baidu_client_secret;
    }
