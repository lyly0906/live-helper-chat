<ul class="nav nav-tabs">
    <li role="presentation" >
        <a href="<?php echo erLhcoreClassDesign::baseurl('chat/chattabs')?>" id="chattabs">聊天标签</a></li>
    <li role="presentation" class="active">
        <a href="<?php echo erLhcoreClassDesign::baseurl('chat/list')?>" id="chatlist">会话列表</a></li>
    <li role="presentation" >
        <a href="<?php echo erLhcoreClassDesign::baseurl('chat/onlineusers')?>" id="onlineusers">在线访客</a></li>
</ul>

<div role="tabpanel" id="chatlist" ng-cloak>
