...
<div role="tabpanel" ng-show="enable_translations">
	<ul class="nav nav-tabs" role="tablist">
		...
		<li role="presentation" <?php if (isset($translation_data['translation_handler']) && $translation_data['translation_handler'] == 'baidu' ) : ?>class="active"<?php endif;?>><a href="#baidu" aria-controls="baidu" role="tab" data-toggle="tab"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/translation','baidu');?></a></li>
	</ul>
	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane <?php if (isset($translation_data['translation_handler']) && $translation_data['translation_handler'] == 'baidu' ) : ?>active<?php endif;?>" id="baidu">
			<label><input type="radio" name="translation_handler" value="baidu" <?php ( (isset($translation_data['translation_handler']) && $translation_data['translation_handler'] == 'baidu') ) ? print 'checked="checked"' : '' ?> /> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/translation','Use baidu service'); ?></label>

			<div class="form-group">
				<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/translation','baidu client ID');?></label>
				<input class="form-control" type="text" name="baidu_client_id" value="<?php (isset($translation_data['baidu_client_id']) && $translation_data['baidu_client_id'] != '') ? print htmlspecialchars($translation_data['baidu_client_id']) : print '' ?>" />
			</div>

			<div class="form-group">
				<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/translation','baidu client secret, key is never shown for security purposes');?></label>
				<input class="form-control" type="text" name="baidu_client_secret" value="" />
			</div>
