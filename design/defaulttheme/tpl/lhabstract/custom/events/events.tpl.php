            ...
            <div class="row">
                <div class="col-xs-4">
                    <div class="form-group">
                        <label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('abstract/widgettheme','Event');?></label>
                ...
                <div class="col-xs-3">
                    <div class="form-group">
                        <label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('abstract/widgettheme','Min number of times');?></label>
                        <input type="text" class="form-control input-sm" name="min_number[]" value="" ng-model="event.min_number" />
                    </div>
                </div>
                <div class="col-xs-3">
                    <div class="form-group">
                        <label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('abstract/widgettheme','During last N seconds');?></label>
