...
<div class="container-fluid toggled" id="wrapper" ng-class="{toggled: lmtoggle}">
    ...
    <?php include(erLhcoreClassDesign::designtpl('pagelayouts/parts/can_use_chat.tpl.php'));?>
        ...
        <div class="row">
            ...
            <div class="col-sm-<?php $canUseChat == true && (!isset($Result['hide_right_column']) || $Result['hide_right_column'] == false) ? print '8' : print '12'; ?> col-md-<?php $canUseChat == true && (!isset($Result['hide_right_column']) || $Result['hide_right_column'] == false) ? print '9' : print '12'; ?> pb10">
                ...
                <?php
                    $strsystem = strstr($_SERVER["QUERY_STRING"],"system");
                    $strabstract = strstr($_SERVER["QUERY_STRING"],"abstract");
                    $strconfig = strstr($_SERVER["QUERY_STRING"],"config");

                ?>
            </div>

            <?php if ($canUseChat == true && (!isset($Result['hide_right_column']) || $Result['hide_right_column'] == false) && empty($strsystem) &&  empty($strsystem) &&  empty($strabstract) &&  empty($strconfig) ) :
